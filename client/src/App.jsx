...
export default function App() {
  ...
  async function handleAdd(ip, mac, descricao, tipo, departamento) {
    const res  = await fetch('/api/computadores', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ ip, mac, descricao, tipo, departamento }),
    })
  ...
  async function handleSave(id, ip, mac, descricao, tipo, departamento) {
